...
<main>
  ...
  <section class="section divisions" id="schedule">
    ...
    <p class="footnote" {@attach reveal()}>
      * Indicative schedule — final times, and how the divisions split across
      the two days, follow with the official announcement.
    </p>
  </section>
  ...
  <section class="cta">
    ...
    <div class="cta__btns" {@attach reveal()}>
      <a
        ...
        rel="noopener">Get tickets</a
      >
      <a class="btn" {@attach magnetic()} href="{base}/regulations"
