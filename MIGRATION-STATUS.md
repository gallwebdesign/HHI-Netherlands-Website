...
tabs for. Those three years were placeholder guesses from the original port.
...
- **Results stay placeholder** (confirmed 11 Aug 2026). Structure is ported and the
  ...
  → **Partly superseded 15 Aug 2026**: 2026 was recovered from the official score
  sheets and is real. 2023–25 are still `placeholderRows()`, and the rule against
  inventing champions still stands. See *Results* above.
